...
We have simulated tumour growth when oxygen supply does not vary over time, hence differences in extracellular oxygen level can only be caused by cell consumption or reduced diffusion owing to higher cell density. 
...
However, the model does not include sudden genetic mutation which can be caused by harsh conditions.
