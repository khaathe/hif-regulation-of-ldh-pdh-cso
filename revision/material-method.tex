...
\end{align}
$D_O$, $D_G$ and $D_{H^+}$ are the diffusion coefficient for each molecules. $N$ is the number of cells in the domain with $f_O^i$, $f_G^i$ and $f_{H^+}^i$ the impact of the cell i on the local extracellular concentration. \\
