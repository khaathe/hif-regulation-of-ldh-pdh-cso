...
Cells consumption and production are described following the functions from the model defined by \cite{Robertson-Tessi2015} (a brief description of the complete model is avail in appendix). \\
