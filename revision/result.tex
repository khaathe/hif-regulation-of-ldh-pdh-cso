...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{img/tumour_current_phase}
    \caption{ 
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{img/plot-proton-rate.png}
    \caption{ 
        ...
        Three genetics pertubations have been selected: reduced oxygen induced degradation  of \acrshort{hif} ($\gamma O_2 \to u = 8.0 $), lower use of glycolysis in hypoxic conditions ( $\gamma u \to v = 2.0 $) and lower effect of hypoxia on oxygen consumption ( $\gamma w \to z = 0.7 $).
        In those simulations, tumour growth was initiated in normoxia.
    }
    \label{fig:proton-prod-rate}
\end{figure}

Results in figure \ref{fig:proton-prod-rate} show acid production according to the extracellular oxygen concentration. 
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{img/plot-ldh-pdh-7d.png}
    \caption{ 
        Plot of level of \acrshort{pdh} against the level of \acrshort{ldh} coloured by the extracellular oxygen concentration.
        The graph shows the results after 7 days of growth for different conditions.
        In oscillating conditions, oxygen concentration is slowly decreased from normoxia to hypoxia during 6h, then oxygen is increased to normoxia at the same rate.
        This process is repeated until the end of the simulation.
        The figure include three different genetic perturbations: reduced oxygen induced degradation  of \acrshort{hif} ($\gamma O_2 \to u = 8.0 $), lower use of glycolysis in hypoxic conditions ( $\gamma u \to v = 2.0 $) and lower effect of hypoxia on oxygen consumption ( $\gamma w \to z = 0.7 $).
        In those last cases, tumour growth was initiated in normoxia.
    }
    \label{fig:ldh-pdh-7d}
\end{figure}    

The fact that, in the model, hypoxia may select cells with high glycolytic activity is supported by the levels of \acrshort{ldh}/\acrshort{pdh} genes presented in figure \ref{fig:ldh-pdh-7d}.
...
Combined with figure \ref{fig:ldh-pdh-7d}, genetic levels seems to indicate that cells cannot enter a complete oxidative state and are trapped either in a hybrid or a glycolytic state. 

\subsubsection{Influence of the intrinsic genetic properties of the cell}

Here, tumour growth is initiated in normoxia (result not shown). 
...
Figure \ref{fig:proton-prod-rate} shows that cells start to become hypoxic after day 1, reaching a majority by day 2.
...
Together with the result in figure \ref{fig:ldh-pdh-7d}, this might be caused by a delay in the response from returning to normal conditions since \acrshort{hif} regulation by O\textsubscript{2} is affected.
