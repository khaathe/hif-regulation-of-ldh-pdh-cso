...
\addcontentsline{toc}{subsection}{Qualitative exploration of the model at the cell scale}
...
\addcontentsline{toc}{subsection}{Exploration of environment and genetic properties on the emergence of the Warburg phenotype}

\subsubsection*{Influence of environmental oxygen conditions}
\addcontentsline{toc}{subsubsection}{Influence of environmental oxygen conditions}
...
\begin{figure}
    ...
    \caption{
        Picture of a spheroid grown for 30 days.
...
\addcontentsline{toc}{subsubsection}{Influence of the intrinsic genetic properties of the
cell}
