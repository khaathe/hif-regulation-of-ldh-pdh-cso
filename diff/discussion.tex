...
We have simulated tumour growth when oxygen supply \DIFdelbegin \DIFdel{doesn't }\DIFdelend \DIFaddbegin \DIFadd{does not }\DIFaddend vary over time, hence differences in extracellular oxygen level can only be caused by cell consumption or reduced diffusion owing to higher cell density. 
...
However, the model \DIFdelbegin \DIFdel{doesn't }\DIFdelend \DIFaddbegin \DIFadd{does not }\DIFaddend include sudden genetic mutation which can be caused by harsh conditions.
