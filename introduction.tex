...
\addcontentsline{toc}{subsection}{HIF Structure and Mechanism of action}
...
\addcontentsline{toc}{subsection}{HIF regulation}
...
\addcontentsline{toc}{subsection}{Impact on cellular biological functions}
...
Thus, \acrshort{hif} upregulates the expression of \acrfull{ldh},
an enzyme that catalyzes the reversible reaction in which pyruvate is converted
to lactate, resulting in higher lactate secretion which acidifies the
microenvironment.

\acrshort{tca} cycle works in cooperation with the \acrshort{oxphos} to
produce \acrshort{atp}.
